...
[![GitHub Release](https://img.shields.io/badge/Release-v1.4.4-blue.svg)](https://github.com/Mashiane/B4XDaisyUIKit-Skills/releases)
...
├── skills-registry.json                     # Machine-readable skill index (id/status/authority/depends/risk)
├── tools/validate-skills.ps1                # Self-audit: registry+deps+refs+lint (run from repo root)
...
└── skills/
    ...
    │   ├── SKILL.md
    │   ├── scripts/
    │   │   ├── extract.py                   # packaged library .bas → work/components.json (corpus + checksums)
    │   │   └── gen_components.py            # components.json → components/*.md, api-cheat-sheet, manifest, provenance JSONs
    │   └── work/                            # extraction artifacts (components.json, api-diff, versioned snapshots)
