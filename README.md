...
[![GitHub Release](https://img.shields.io/badge/Release-v1.2.1-blue.svg)](https://github.com/Mashiane/B4XDaisyUIKit-Skills/releases)
...
* **91 Component Guides:** Detailed specifications in `components/<name>.md` covering constructor parameters, designer properties, methods, events, and recipes.
